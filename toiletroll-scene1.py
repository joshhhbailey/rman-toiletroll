...
def SetupDisplay():
    ...
    ri.Display("toiletroll-01.exr", "openexr", "Ci,a,mse,albedo,albedo_var,diffuse,diffuse_mse,specular,specular_mse,z,z_var,normal,normal_var,forward,backward", {"int asrgba" : [1]})
